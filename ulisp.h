...
static void error2 (object *symbol, const char *string);
static char nthchar (object *string, int n);
static void pserial (char c);
static void pfl (pfun_t pfun);
static void pfstring (const char *s, pfun_t pfun);
static inline void pln (pfun_t pfun);
static char *lookupsymbol (symbol_t name);
static void pint (int i, pfun_t pfun);
static uint8_t lookupmin (symbol_t name);
static uint8_t lookupmax (symbol_t name);
static void testescape ();
static int gserial ();
static object *read (gfun_t gfun);
static void deletesymbol (symbol_t name);
static void printstring (object *form, pfun_t pfun);
static object *edit (object *fun);
static void superprint (object *form, int lm, pfun_t pfun);
static int subwidthlist (object *form, int w);
static void pstring (char *s, pfun_t pfun);
static void supersub (object *form, int lm, int super, pfun_t pfun);
static object *apply (object *function, object *args, object **env);
